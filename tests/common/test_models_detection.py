...
from deepocr.models.detection.differentiable_binarization.base import DBPostProcessor
from deepocr.models.detection.linknet.base import LinkNetPostProcessor

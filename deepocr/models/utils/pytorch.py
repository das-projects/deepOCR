...
from deepocr.utils.data import download_from_url
...
def load_pretrained_params(
    ...
    **kwargs: Any,
    ...
    Example::
        >>> from deepocr.models.utils import load_pretrained_params
    ...
    if url is None:
        ...
        state_dict = torch.load(archive_path, map_location=device)
...
def conv_sequence_pt(
    ...
    **kwargs: Any,
    ...
    Example::
        >>> from deepocr.models.utils import conv_sequence_pt
        >>> from torch.nn import Sequential
        >>> module = Sequential(conv_sequence_pt(3, 32, True, True, kernel_size=3))

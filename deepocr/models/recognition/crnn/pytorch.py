...
from deepocr.datasets import VOCABS, decode_sequence
...
def crnn_vgg16_bn(pretrained: bool = False, **kwargs: Any) -> CRNN:
    ...
    Example::
        >>> import torch
        >>> from deepocr.models import crnn_vgg16_bn
...
def crnn_mobilenet_v3_small(pretrained: bool = False, **kwargs: Any) -> CRNN:
    ...
    Example::
        >>> import torch
        >>> from deepocr.models import crnn_mobilenet_v3_small
...
def crnn_mobilenet_v3_large(pretrained: bool = False, **kwargs: Any) -> CRNN:
    ...
    Example::
        >>> import torch
        >>> from deepocr.models import crnn_mobilenet_v3_large

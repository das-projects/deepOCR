...
import deepocr
from deepocr.utils.common_types import BoundingBox
from deepocr.utils.geometry import resolve_enclosing_bbox, resolve_enclosing_rbbox
from deepocr.utils.repr import NestedObject
from deepocr.utils.visualization import synthesize_page, visualize_page
...
class Page(Element):
    ...
    def export_as_xml(self, file_title: str = 'docTR - XML export (hOCR)') -> Tuple[bytes, ET.ElementTree]:
        ...
        SubElement(head, 'meta', attrib={'name': 'ocr-system', 'content': f"python-doctr {deepocr.__version__}"})

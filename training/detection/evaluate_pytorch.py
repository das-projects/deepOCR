...
from deepocr import transforms as T
from deepocr.models import detection
from deepocr.utils.metrics import LocalizationConfusion
...
def parse_args():
    ...
    parser.add_argument('--rotation', type=bool, default='False', dest='rotation', action='store_true',
